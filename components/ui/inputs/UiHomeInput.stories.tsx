...
import UiHomeInput from "./UiHomeInput";
import { useState } from "react";

export default {
  title: "ui/inputs/UiHomeInput",
  component: UiHomeInput,
};

const Template: StoryFn<typeof UiHomeInput> = (args) => {
  const [Value, setValue] = useState("cai");

  return <UiHomeInput {...args} Value={Value} setValue={setValue} />;
};
