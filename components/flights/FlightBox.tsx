...
export default function FlightBox({ data }: { data: FlightOfferingEntity }) {
  ...
  return (
    <div className="flex flex-col gap-4 p-3 bg-zinc-200 rounded-xl">
      <div>
        <div className="grid md:grid-cols-[max-content_1fr_1fr_1fr_1fr_max-content] grid-cols-[max-content_1fr_max-content] items-center gap-5">
          {" "}
          <div className="w-10 h-10 p-2 rounded-full icon bg-zinc-200">
            <img
          ...
          <div className="flex-col hidden md:flex">
            <div className="text-xl font-bold">{data.totalDuration.en}</div>
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 transition-all rounded-full active:scale-90 bg-zinc-300"
          >
            <IoIosArrowDown
              className={`${
    ...
    <div className="flex flex-col p-2 pt-3 md:p-3">
      ...
      <div className="flex gap-3 pt-4 pl-2">
        ...
        <div className="flex flex-col gap-4 text-sm md:text-md">
          ...
          <div className="text-sm text-zinc-600">${flight.duration.en}</div>
